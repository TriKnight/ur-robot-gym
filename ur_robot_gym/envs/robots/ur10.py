...
from ur_robot_gym.envs.core import PyBulletRobot



class UR10(PyBulletRobot):
    """Universal Robot UR10 in PyBullet.
    ...
    """
    JOINT_INDICES = [0, 1, 2, 3, 4, 5, 7, 8]
    FINGERS_INDICES = [7, 8]
    NEUTRAL_JOINT_VALUES = [0.00, 0.0, 0.00, 0.0, -0.00, 0.0, 0, 0]
    JOINT_FORCES = [87, 87, 87, 87, 87, 120, 170, 170]
    ...
    def __init__(self, sim, block_gripper=False, base_position=[0, 0, 0], fingers_friction=1.0):
        ...
        super().__init__(
            sim,
            body_name="ur10",
            file_name= "/ur10/ur10_robot.urdf",
    ...
    def _inverse_kinematics(self, position, orientation):
        ...
        inverse_kinematics = list(inverse_kinematics[0:6]) + [0, 0]
